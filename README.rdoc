...
** Creating a search method within the page was not a requirement for the project. The
   default is to retrieve results for the keyword "chocolate". Appending search="x" to the url will search the food2fork api for x. For example https://recipefinder32707.herokuapp.com?search=mocha
